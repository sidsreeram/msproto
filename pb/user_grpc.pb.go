...
type UserServiceClient interface {
	UserSignup(ctx context.Context, in *SignupRequest, opts ...grpc.CallOption) (*UserResponse, error)
...
func (c *userServiceClient) UserSignup(ctx context.Context, in *SignupRequest, opts ...grpc.CallOption) (*UserResponse, error) {
...
type UserServiceServer interface {
	UserSignup(context.Context, *SignupRequest) (*UserResponse, error)
...
func (UnimplementedUserServiceServer) UserSignup(context.Context, *SignupRequest) (*UserResponse, error) {
